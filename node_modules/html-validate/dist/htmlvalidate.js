...
class HtmlValidate {
    ...
    validateSource(input, configOverride) {
        ...
        const engine = new engine_1.Engine(config.resolve(), config.get(), parser_1.Parser);
    ...
    getRuleDocumentation(ruleId, config = null, context = null) {
        ...
        const engine = new engine_1.Engine(c.resolve(), c.get(), parser_1.Parser);
    ...
    getParserFor(source) {
        ...
        return new parser_1.Parser(config.resolve());
    }
    /**
...
//# sourceMappingURL=htmlvalidate.js.map