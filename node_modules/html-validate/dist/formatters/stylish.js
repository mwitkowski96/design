...
const stylish_1 = __importDefault(require("@html-validate/stylish"));
...
function linkSummary(results) {
    ...
    return `\n${kleur_1.default.bold("More information")}:\n${lines.join("")}\n`;
}
function stylish(results) {
    const errors = stylish_1.default(results.map((it) => (Object.assign(Object.assign({}, it), { fixableErrorCount: 0, fixableWarningCount: 0 }))));
