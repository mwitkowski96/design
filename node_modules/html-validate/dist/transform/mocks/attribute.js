...
function* processAttribute(attr) {
    ...
    if (typeof attr.value === "string" && attr.value.match(/{{.*}}/)) {
        yield Object.assign(Object.assign({}, attr), { value: new dom_1.DynamicValue(attr.value) });
        return;
    }
    ...
    if (attr.key.startsWith("dynamic-")) {
        yield Object.assign(Object.assign({}, attr), { key: attr.key.replace("dynamic-", ""), value: new dom_1.DynamicValue(attr.value), originalAttribute: attr.key });
    }
}
